...
class LeducholdemRound:
    ...
    def start_new_round(self, game_pointer, raised=None):
        ...
        Note: For the first round of the game, we need to set up the big/small blind
        """
    ...
    def proceed_round(self, players, action):
        ...
        if all(player.status == 'folded' for player in players):
            return None
    ...
    def get_legal_actions(self):
        ...
        # If the number of raises already reaches the maximum number raises, we can not raise anymore
